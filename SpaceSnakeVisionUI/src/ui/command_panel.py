...
class TaskCommandPanel(QWidget):
    ...
    def _build_param_forms(self) -> None:
        ...
        self.move_to_x = self._double_spin(-1.5, 1.5, 0.35, step=0.01, decimals=3, suffix=" m")
        self.move_to_y = self._double_spin(-1.5, 1.5, 0.00, step=0.01, decimals=3, suffix=" m")
        ...
        self.move_along_d = self._double_spin(0.01, 1.50, 0.10, step=0.01, decimals=3, suffix=" m")
        ...
        self.place_dest_combo.addItems(["Assembly_Port_A", "Assembly_Port_B", "Holding_Zone", "Safe_Zone"])
        ...
        self.rot_arm_n = self._spin(1, 16, 1)
        ...
        self.facing_arm_n = self._spin(1, 16, 1)
